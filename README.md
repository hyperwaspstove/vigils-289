...
```bash
git clone https://github.com/hyperwaspstove/vigils-289.git
cd vigils-289
cargo build --release
cargo run
```
...
[![CI](https://github.com/hyperwaspstove/vigils-289/actions/workflows/ci.yml/badge.svg)](https://github.com/hyperwaspstove/vigils-289/actions/workflows/ci.yml)
...
<!-- Last updated: 2026-06-06 16:11:07 -->
